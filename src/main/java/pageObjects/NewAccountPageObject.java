...
//	}
	...
	// DynamicLocator.INITIAL_DEPOSIT);
	//
	// if (driver.toString().toLowerCase().contains("internetexplorer")) {
	// sendkeyToElementByJS(driver, initialDeposit,
	// AbstractPageUI.DYNAMIC_TEXTBOX, DynamicLocator.INITIAL_DEPOSIT);
	// } else {
	// sendkeyToElement(driver, initialDeposit, AbstractPageUI.DYNAMIC_TEXTBOX,
	// DynamicLocator.INITIAL_DEPOSIT);
	// }
	// }
