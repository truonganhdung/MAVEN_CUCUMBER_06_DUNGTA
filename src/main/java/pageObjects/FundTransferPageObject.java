...
public class FundTransferPageObject extends AbstractPage {
	...
	// DynamicLocator.PAYERS_ACCOUNT_NUMBER);
	//
	// if (driver.toString().toLowerCase().contains("internetexplorer")) {
	// sendkeyToElementByJS(driver, payersAccountNo,
	// AbstractPageUI.DYNAMIC_TEXTBOX, DynamicLocator.PAYERS_ACCOUNT_NUMBER);
	// } else {
	// sendkeyToElement(driver, payersAccountNo, AbstractPageUI.DYNAMIC_TEXTBOX,
	// DynamicLocator.PAYERS_ACCOUNT_NUMBER);
	// }
	// }
	//
	...
	// waitForControlVisible(driver, AbstractPageUI.DYNAMIC_TEXTBOX,
	// DynamicLocator.PAYEES_ACCOUNT_NUMBER);
	//
	// if (driver.toString().toLowerCase().contains("internetexplorer")) {
	// sendkeyToElementByJS(driver, payeesAccountNo,
	// AbstractPageUI.DYNAMIC_TEXTBOX, DynamicLocator.PAYEES_ACCOUNT_NUMBER);
	// } else {
	// sendkeyToElement(driver, payeesAccountNo, AbstractPageUI.DYNAMIC_TEXTBOX,
	// DynamicLocator.PAYEES_ACCOUNT_NUMBER);
	// }
	// }
	//
	...
	// waitForControlVisible(driver, AbstractPageUI.DYNAMIC_TEXTBOX,
	// DynamicLocator.AMOUNT);
	//
	// if (driver.toString().toLowerCase().contains("internetexplorer")) {
	// sendkeyToElementByJS(driver, amount, AbstractPageUI.DYNAMIC_TEXTBOX,
	// DynamicLocator.AMOUNT);
	// } else {
	// sendkeyToElement(driver, amount, AbstractPageUI.DYNAMIC_TEXTBOX,
	// DynamicLocator.AMOUNT);
	// }
	// }
